...
%     {[Clothoid], Circular, Bézier}. (int value saveCalculatedData)      %
...
%   are collision free, please uncomment plotRobotPath(LSL_W) at the      %
%   bottom of the function, in the plotting section. This will plot       %
%   the robot shape over all collision-free paths.                        %
%                                                                         %
