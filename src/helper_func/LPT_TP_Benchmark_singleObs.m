function LPT_TP_Benchmark_singleObs(stepSize,saveFigure)
...
set(gca,'FontSize',14)
hold off
if saveFigure; saveCurrentFigure('TimeBench_SingleObs_mat_hist'); end
...
set(gca,'FontSize',14)
hold off
if saveFigure; saveCurrentFigure('TimeBench_SingleObs_mat_PathInfluence'); end
