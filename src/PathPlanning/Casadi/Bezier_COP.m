...
initCOP=struct('Pstart',Pstart,'Pgoal',Pgoal,'n',n,'t',t,'weights',weights,'kappa_max',kappa_max,'obs',obs);
...
fill(obs(:,1),obs(:,2),'k')
plot(sepLineX,sepLineY,'LineWidth',1.5)
xlabel('x [m]')
ylabel('y [m]')
axis([-0.5 2.5 -0.5 2.5])
axis equal
legend('Bezier curve','Bezier Control Point','Convex hull','Start-Goal position ','Obstacle')
% subplot(2,1,2)
