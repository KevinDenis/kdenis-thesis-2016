...
for kk = 1:length(StateLaticeMatrix_Augmented)
    ...
    G(ii,jj) = StateLaticeMatrix_Augmented(kk,end)+StateLaticeMatrix_Augmented(kk,end-1);
    G(jj,ii) = StateLaticeMatrix_Augmented(kk,end)+StateLaticeMatrix_Augmented(kk,end-1);
end
