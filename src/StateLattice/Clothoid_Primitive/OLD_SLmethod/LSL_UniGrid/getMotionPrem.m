function [MotionPrem] = getMotionPrem(MP_par)
...
[grid_X_Y_TH1] = GridRotTrans(MP_par);

x0=MP_par.x0;
y0=MP_par.y0;
th0=MP_par.th0;
kappa_max=MP_par.k_max;
res=MP_par.res;

dX=grid_X_Y_TH1(:,1)-x0;
dY=grid_X_Y_TH1(:,2)-y0;

grid_X_Y_TH1=grid_X_Y_TH1(abs(dX)+abs(dY)>0,:);
...
nn=1;
for ii=1:length(grid_X_Y_TH1)
    x1=grid_X_Y_TH1(ii,1); 
    y1=grid_X_Y_TH1(ii,2); 
    th1=grid_X_Y_TH1(ii,3);
