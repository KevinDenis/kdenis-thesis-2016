...
sol = optisolve(objectiveFunction(x,y,initCOP),constraintsConservatief(x,y,a,b,initCOP));
x_sol=optival(x);
y_sol=optival(y);
a_sol=optival(a);
b_sol=optival(b);
...
sol = optisolve(objectiveFunction(x,y,initCOP),constraintsFull(x,y,a,b,initCOP));
x_sol=optival(x);
y_sol=optival(y);
a_sol=optival(a);
b_sol=optival(b);
...
sol = optisolve(objectiveFunction(x,y,initCOP),constraintsSplitted(x,y,a,b,initCOP));
x_sol=optival(x);
y_sol=optival(y);
a_sol=optival(a);
b_sol=optival(b);
